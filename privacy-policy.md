...
### Camera Permission
We request camera access to allow you to photograph pages of a document (i.e. book) to create audiobooks.
- Photos are processed to extract text
- Images are stored only for audiobook creation
